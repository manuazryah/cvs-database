            ...
            <div class="content" style="margin: 0px 15%;border: 1px solid #d4d1d1;">
                ...
                <div class="content-detail" style="padding: 0px 10%;">
                    ...
                    <p style="margin: 30px 0px;">
                        <a href="https://<?= Yii::$app->getRequest()->serverName ?><?= Yii::$app->homeUrl ?>site/email-verification?token=<?= Yii::$app->EncryptDecrypt->Encrypt('encrypt', $model->id) ?>" style="background: #2881c0;padding: 10px 20px;text-decoration: none;color: white;">Click Here</a>
                    </p>
                    <h3 style="text-align: center;color: #464444;background: #ffffff;padding: 0px;">OR</h3>
                    <p> Copy & paste the below link to your browser</p>
                    <p style="color: #2881c0;"><?= Yii::$app->getRequest()->serverName ?><?= Yii::$app->homeUrl ?>site/email-verification?token=<?= Yii::$app->EncryptDecrypt->Encrypt('encrypt', $model->id) ?></p>
