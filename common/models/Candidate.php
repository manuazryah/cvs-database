...
class Candidate extends ActiveRecord implements IdentityInterface {
    ...
    public function rules() {
        return [
            ...
            [['date_of_creation', 'date_of_updation', 'phone', 'address', 'alternate_phone', 'alternate_address','last_login'], 'safe'],
    ...
    protected function getUser() {
        if ($this->_user === null) {
            $this->_user = static::find()->where('email = :uname', ['uname' => $this->user_name])->one();
        }
        return $this->_user;
    }
