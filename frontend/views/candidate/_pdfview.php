                                        ...
                                        <div class="candidateinfo im-user-detail">
                                            <table style="width: 100%">
                                                <tr>
                                                    ...
                                                    <td style="width: 70%">
                                                        <table style="width: 100%">
                                                            <tr><td colspan="2"><strong><h4 style="font-size: 22px; margin-bottom: 20px; text-transform: capitalize;"><?= $model->name ?></h4></strong></td></tr>
                                                            <tr>
                                                                <td style="line-height: 22px;"><strong>Title : </strong><?= $model->title ?></td>
                                                            </tr>
                                                            <tr>
                                                                <td style="line-height: 22px;"><strong>Job Status : </strong> <?= $model->job_status != '' ? common\models\JobStatus::findOne($model->job_status)->job_status : '' ?></td>
                                                            </tr>
                                                            <tr>
                                                                <td style="line-height: 22px;"><strong>Nationality : </strong><?= $model->nationality != '' ? \common\models\Country::findOne($model->nationality)->country_name : '' ?></td>
                                                            </tr>
                                                            <tr>
                                                                <td style="line-height: 22px;"><strong>Currently:</strong> <?= $model->current_country != '' ? \common\models\Country::findOne($model->current_country)->country_name : '' ?> , <?= $model->current_city != '' ? \common\models\City::findOne($model->current_city)->city : '' ?></td>
                                                            </tr>
                                                            <tr>
                                                                <td style="line-height: 22px;"><strong>Phone : </strong> <?= $candidate->phone ?></td>
                                                            </tr>
                                                            <tr>
                                                                <td style="line-height: 22px;"><strong>Email : </strong> <?= $candidate->email ?></td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                    <td style="width: 30%">
                                ...
                                <div class="job-header" style="background: #fff; border: 1px solid #e4e4e4; margin-bottom: 30px;">
                                    <div class="contentbox pad0">
                                        <div class="page-heading" style="padding-bottom: 20px;">
                                            ...
                                            <div class="contact_details col-md-12 p-l" style="font-size: 14px; line-height: 1.42857143; color: #2c2e2f; background-color: #fff; font-family: 'Montserrat', sans-serif;">
                                        ...
                                        <div class="page-heading cv-work-experience" style="padding-bottom: 20px;">
                                            ...
                                            if (!empty($model_experience)) {
                                                foreach ($model_experience as $experience) {
                                                    ?>
                                                    <div class="contact_details" style="padding: 11px 15px; border: 1px solid #eceaea; margin-bottom: 20px;">
                                                        ...
                                                        <div class="clearfix"></div>
                                                        <br>
                                                        <span style="margin-top: 0px; line-height: 24px; color: #555; display: block; padding-bottom: 0px; font-size: 12px; text-transform: capitalize;">Job Responsibilities: <?= $experience->job_responsibility ?></span>
                                                    </div>
                                                    <?php
                                                }
                                            }
                                        ...
                                        <div class="page-heading cv-work-experience" style="padding-bottom: 20px;">
                                            ...
                                            if (!empty($model_education)) {
                                                ?>
                                                <table class="table inner-tbl1" style="padding: 11px 15px; border: 1px solid #eceaea; margin-bottom: 20px;">
