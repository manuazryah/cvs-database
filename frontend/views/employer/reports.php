                    ...
                    <div class="invoice-details"style="margin-top: 10px;min-height: 300px;">
                        <table style="width:100%;border-collapse: collapse;text-align: center;">
                            <tr style="background: #4e5254;color: white !important;">
                                ...
                                <th style="font-size: 12px;padding: 10px 2px;">Package Credit</th>
                            ...
                            <tr>
                                ...
                                <td style="font-size: 12px;padding: 10px 2px;"><?= $package_history->package_credit ?></td>
                                ...
                                <td style="font-size: 12px;padding: 10px 2px;">Active</td>
