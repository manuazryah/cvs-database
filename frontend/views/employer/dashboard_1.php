            ...
            <div class="account-info">
                <div class="box">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 top-box-btm">
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 brit"><p>Search Result : Total <span><?= $dataProvider->getTotalCount() ?> CVs</span> Found</p></div>
                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 pad0">
                            <div class="col-sm-7"><p class="color-white txt-center">You have <span><?= $user_plans->no_of_downloads_left ?> Credits</span> Remaining for CV Download</p></div>
                            <div class="col-sm-5 blft txt-right"><p>Your Credit Expiry on <span><?= date("d M Y", strtotime($user_plans->end_date)) ?></span></p></div>
                        </div>
                    </div>
                    <div class="clearfix"></div>
                </div>
