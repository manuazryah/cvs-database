...
<div class="admin-users-index">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pad0 search-sec">
            ...
            <div class="account-info">
                <div class="box">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 top-box-btm">
                        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 brit"><p>Search Result : Total <span><?= $dataProvider->getTotalCount() ?> CVs</span> Found</p></div>
                        <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 pad0">
                            <div class="col-lg-7 col-md-7 col-sm-12 col-xs-12"><p class="color-white txt-center">You have <span><?= $user_plans->no_of_downloads_left ?> Credits</span> Remaining for CV Download</p></div>
                            <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12 blft txt-right"><p>Your Credit Expiry on <span><?= date("d M Y", strtotime($user_plans->end_date)) ?></span></p></div>
                        </div>
                    </div>
                    <div class="clearfix"></div>
                </div>
...
//                                    echo $form1->field($model_filter, 'job_types[]')->checkboxList($arr_job, ['class' => 'check-label'])->label(FALSE);
                                            ...
                                            <div class="filter-mobile-box"><!--filter-mobile-box-->
                                                <div id="button" type="button" class="filter-list-button job_title" data-toggle="collapse" data-target="#demo10">Shortlist Folder <span class="right-span">+</span></div>

                                                <div id="demo10" class="collapse categories-filter" val='button'>
                                                    <div class="page-heading check-label">
                                                        <div class="search-scroll pad-tp">
                                                            <?php
...
<div id="employer_detail" class="modal loger_popup fade" role="dialog">
