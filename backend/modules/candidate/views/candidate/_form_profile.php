                                ...
                                <div class="userccount">
                                    <div class="formpanel">
                                        ...
                                        <div class="form-group col-md-12 p-l p-r marg-bot-0">
                                            ...
                                            <?= Html::button('<span> Not in the list ? Request New</span>', ['value' => Url::to('../candidate/candidate/add-industry'), 'class' => 'btn btn-icon btn-white extra_btn candidate_prof_add modalButton']) ?>
                                        </div>
                                        ...
                                        <div class="form-group col-md-12 p-l p-r marg-bot-0">
                                            ...
                                            <?= Html::button('<span> Not in the list ? Request New</span>', ['value' => Url::to('../candidate/candidate/add-skill'), 'class' => 'btn btn-icon btn-white extra_btn candidate_prof_add modalButton']) ?>
                                        </div>
                                        <div class="clearfix"></div>
                                                    ...
                                                    if (!empty($datas)) {
                                                        ...
                                                        <div class="append-box">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="formrow">
                                                                        <textarea class="textarea form-control" name="expupdatee[<?= $datas->id; ?>][job_responsibility][]" placeholder="Job Responsibility" style="width:100%;height: 150px;"><?= $datas->job_responsibility ?></textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
