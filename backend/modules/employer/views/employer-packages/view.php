...
$this->title = 'Package Details : ' . \common\models\Employer::findOne($user_package->employer_id)->first_name;
        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <?= Html::a('<i class="fa fa-toggle-up"></i><span> Upgrade Your Package</span>', ['upgrade-package', 'emp_id' => $user_package->employer_id], ['class' => 'btn btn-warning  btn-icon btn-icon-standalone', 'style' => '']) ?>
                    <?= Html::a('<i class="fa fa-edit"></i><span> Edit Package</span>', ['update', 'id' => $user_package->id], ['class' => 'btn btn-warning  btn-icon btn-icon-standalone', 'style' => '']) ?>
                    <button id="pack-histry-btn" class="btn btn-warning  btn-icon btn-icon-standalone" style="margin-left: 20px;">
                            ...
                            'columns' => [
                                ...
                                [
                                    ...
                                    'urlCreator' => function ($action, $model) {
                                        if ($action === 'print') {
                                            $url = Url::to(['/employer/employer-packages/report', 'id' => $model->id]);
                                            return $url;
                                        }
                                    }
                                ],
