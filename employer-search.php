    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center">
                <div class="banner-heading">Hire Candidates</div>    
            </div>  
        </div>
    </div>
</div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12 prit0">
                    <div class="col-md-8 col-sm-8 p-l">
                        <div class="page-heading">
                            <p><span class="color-drk">Your Search Filter</span>: "Sales", "UAE", "Dubai", "Male","1 year - 5year Experienced"</p>
                        </div>
                    </div>  
                    <div class="col-md-4 col-sm-4 filter text-right">
                        <div class="col-md-3 col-sm-3"></div>
                        <div class="col-md-4 col-sm-4"><p>Sort by :</p></div>
    ...
    <!--                                <div class="tab-image"><img src="images/candidates/candidate-1.png" alt="" class="img-responsive"></div>
                                    ...
                                    <div class="bottom_text">
                                        ...
                                        <div class="contact_details col-md-6 col-sm-6 p-l">
                                            <span><strong>Currently:</strong> Dubai, UAE</span>
                                        </div>
                                        ...
                                        <div class="contact_details col-md-12 col-sm-12 p-l">
                                            <span><strong>Job Status:</strong> Looking for job</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 p-l">
                                <div class="button-box">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pad0">
                                        ...
                                        <a href="" class="button3">View CV <br><span><i class="fas fa-eye"></i></span></a>
                                    </div>
                                </div>
                            </div>
                            <div class="bottom-box col-lg-12">
                                <div class="last-login col-md-6 col-sm-6 p-l">
                                    <span><i>Last Logged in : 02 Dec 2017</i></span>
                                </div>
                                <div class="last-login col-md-6 col-sm-6 p-l">
